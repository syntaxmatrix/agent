    ...
    <div className="min-h-screen bg-slate-950 flex flex-col items-center justify-center p-6 font-sans selection:bg-indigo-500/30 selection:text-white">
      ...
      <div className="w-full max-w-[400px] animate-in fade-in slide-in-from-bottom-4 duration-1000">
        <div className="text-center mb-8">
           ...
           <p className="text-slate-400 text-sm">Enter your email to sign in to your account.</p>
        </div>
        ...
        <div className="bg-slate-900/40 backdrop-blur-xl border border-white/5 rounded-[2rem] p-8 shadow-2xl">
          <form className="space-y-6" onSubmit={(e) => e.preventDefault()}>
            ...
            <button
              type="submit"
              className="w-full bg-indigo-600 hover:bg-indigo-500 text-white rounded-xl py-3 text-sm font-semibold transition-all duration-300 hover:translate-y-[-1px] active:scale-[0.98] shadow-lg shadow-indigo-500/10 flex items-center justify-center gap-2 group"
            >
              Continue
        ...
        <p className="mt-8 text-center text-sm text-slate-500">
          ...
          <Link href="/signup" className="text-indigo-400 font-semibold hover:text-indigo-300 transition-colors ml-1">
            Sign up
          </Link>
        </p>
      </div>
