    ...
    <div className="min-h-screen flex items-center justify-center p-6 bg-background relative overflow-hidden">
      ...
      <div className="w-full max-w-[440px] animate-in fade-in slide-in-from-bottom-8 duration-700">
        <div className="text-center mb-10">
          ...
          <h1 className="text-3xl font-display font-bold text-slate-800 tracking-tight mb-2">Create Account</h1>
          <p className="text-slate-500 font-medium">Join the next generation of AI productivity</p>
        </div>
        ...
        <div className="bg-white rounded-[2.5rem] border border-slate-100 human-shadow p-8 md:p-10">
          ...
          <div className="relative my-8 text-center" aria-hidden="true">
            ...
            <span className="relative px-4 py-1 text-[10px] font-bold text-slate-400 bg-white uppercase tracking-widest">or sign up with</span>
          </div>
        ...
        <p className="text-center mt-8 text-sm font-medium text-slate-500">
          Already have an account? <Link href="/signin" className="text-slate-900 font-bold hover:underline">Sign in</Link>
        </p>
      </div>
    </div>
  )
